  ...
  return (
    <section className="w-full flex items-center mt-32">
      <article className="flex items-end w-full">
        <div className="shrink-0 mr-5 w-20 h-20 sm:w-[120px] sm:h-[120px]">
          <Image
        ...
        <div className="max-w-[400px] text-xs sm:text-base">
          <p className="font-bold text-lg sm:text-xl mb-3">안녕하세요!🖐️</p>
